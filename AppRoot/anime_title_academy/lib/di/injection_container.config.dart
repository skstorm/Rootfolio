...
import '../core/config/app_runtime_config.dart' as _i21;
...
import '../features/title_academy/data/title_usage_local_datasource.dart'
    as _i181;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.singleton<_i21.AppRuntimeConfig>(() => appModule.runtimeConfig);
    ...
    gh.lazySingleton<_i181.TitleUsageLocalDatasource>(
      () => _i181.TitleUsageLocalDatasource(gh<_i460.SharedPreferences>()),
    );
    ...
    gh.lazySingleton<_i922.AdService>(
      () => appModule.getAdService(gh<_i21.AppRuntimeConfig>()),
    );
    gh.lazySingleton<_i664.TitleUsageQuotaService>(
      () => _i664.TitleUsageQuotaService.create(
        gh<_i181.TitleUsageLocalDatasource>(),
        gh<_i21.AppRuntimeConfig>(),
      ),
    );
